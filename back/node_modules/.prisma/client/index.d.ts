...
/**
   ...
   * `prisma.mute`: Exposes CRUD operations for the **Mute** model.
    ...
    * ```
    */
  get mute(): Prisma.MuteDelegate<GlobalReject>;
}
...
export namespace Prisma {
  ...
  */
  ...
  export type UsersSelect = {
    ...
    kicks?: boolean | Users$kicksArgs
    bans?: boolean | Users$bansArgs
    mutes?: boolean | Users$mutesArgs
  ...
  export type UsersGetPayload<S extends boolean | null | undefined | UsersArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'kicks' ? Array < ChannelsGetPayload<S['include'][P]>>  :
        P extends 'bans' ? Array < ChannelsGetPayload<S['include'][P]>>  :
        P extends 'mutes' ? Array < MuteGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'kicks' ? Array < ChannelsGetPayload<S['select'][P]>>  :
        P extends 'bans' ? Array < ChannelsGetPayload<S['select'][P]>>  :
        P extends 'mutes' ? Array < MuteGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__UsersClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    kicks<T extends Users$kicksArgs= {}>(args?: Subset<T, Users$kicksArgs>): Prisma.PrismaPromise<Array<ChannelsGetPayload<T>>| Null>;

    bans<T extends Users$bansArgs= {}>(args?: Subset<T, Users$bansArgs>): Prisma.PrismaPromise<Array<ChannelsGetPayload<T>>| Null>;

    mutes<T extends Users$mutesArgs= {}>(args?: Subset<T, Users$mutesArgs>): Prisma.PrismaPromise<Array<MuteGetPayload<T>>| Null>;
   ...
   * Users.mutes
   */
  export type Users$mutesArgs = {
    /**
     * Select specific fields to fetch from the Mute
     */
    select?: MuteSelect | null
    /**
     * Choose, which related nodes to fetch as well.
     */
    include?: MuteInclude | null
    where?: MuteWhereInput
    orderBy?: Enumerable<MuteOrderByWithRelationInput>
    cursor?: MuteWhereUniqueInput
    take?: number
    skip?: number
    distinct?: Enumerable<MuteScalarFieldEnum>
  }
  ...
  export type ChannelsSelect = {
    ...
    kicks?: boolean | Channels$kicksArgs
    bans?: boolean | Channels$bansArgs
    mutedUsers?: boolean | Channels$mutedUsersArgs
  ...
  export type ChannelsGetPayload<S extends boolean | null | undefined | ChannelsArgs> =
    ...
    [P in TruthyKeys<S['include']>]:
        ...
        P extends 'kicks' ? Array < UsersGetPayload<S['include'][P]>>  :
        P extends 'bans' ? Array < UsersGetPayload<S['include'][P]>>  :
        P extends 'mutedUsers' ? Array < MuteGetPayload<S['include'][P]>>  :
    ...
    [P in TruthyKeys<S['select']>]:
        ...
        P extends 'kicks' ? Array < UsersGetPayload<S['select'][P]>>  :
        P extends 'bans' ? Array < UsersGetPayload<S['select'][P]>>  :
        P extends 'mutedUsers' ? Array < MuteGetPayload<S['select'][P]>>  :
  ...
  export class Prisma__ChannelsClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    ...
    kicks<T extends Channels$kicksArgs= {}>(args?: Subset<T, Channels$kicksArgs>): Prisma.PrismaPromise<Array<UsersGetPayload<T>>| Null>;

    bans<T extends Channels$bansArgs= {}>(args?: Subset<T, Channels$bansArgs>): Prisma.PrismaPromise<Array<UsersGetPayload<T>>| Null>;

    mutedUsers<T extends Channels$mutedUsersArgs= {}>(args?: Subset<T, Channels$mutedUsersArgs>): Prisma.PrismaPromise<Array<MuteGetPayload<T>>| Null>;
   ...
   * Channels.kicks
   */
  export type Channels$kicksArgs = {
    /**
     * Select specific fields to fetch from the Users
     */
    select?: UsersSelect | null
   ...
   * Channels.mutedUsers
   */
  export type Channels$mutedUsersArgs = {
    /**
     * Select specific fields to fetch from the Mute
     */
    select?: MuteSelect | null
  ...
  export type MuteGroupByArgs = {
    where?: MuteWhereInput
    orderBy?: Enumerable<MuteOrderByWithAggregationInput>
    by: MuteScalarFieldEnum[]
  ...
  type GetMuteGroupByPayload<T extends MuteGroupByArgs> = Prisma.PrismaPromise<
    Array<
      PickArray<MuteGroupByOutputType, T['by']> &
        {
  ...
  export type MuteSelect = {
    id?: boolean
    userId?: boolean
    channelId?: boolean
    muteEndTime?: boolean
    user?: boolean | UsersArgs
    channel?: boolean | ChannelsArgs
  }


  export type MuteInclude = {
    user?: boolean | UsersArgs
    channel?: boolean | ChannelsArgs
  }

  export type MuteGetPayload<S extends boolean | null | undefined | MuteArgs> =
    S extends { select: any, include: any } ? 'Please either choose `select` or `include`' :
    S extends true ? Mute :
    S extends undefined ? never :
    S extends { include: any } & (MuteArgs | MuteFindManyArgs)
    ? Mute  & {
    [P in TruthyKeys<S['include']>]:
        P extends 'user' ? UsersGetPayload<S['include'][P]> :
        P extends 'channel' ? ChannelsGetPayload<S['include'][P]> :  never
  } 
    : S extends { select: any } & (MuteArgs | MuteFindManyArgs)
      ? {
    [P in TruthyKeys<S['select']>]:
        P extends 'user' ? UsersGetPayload<S['select'][P]> :
        P extends 'channel' ? ChannelsGetPayload<S['select'][P]> :  P extends keyof Mute ? Mute[P] : never
  } 
      : Mute


  type MuteCountArgs = 
    Omit<MuteFindManyArgs, 'select' | 'include'> & {
      select?: MuteCountAggregateInputType | true
    }

  export interface MuteDelegate<GlobalRejectSettings extends Prisma.RejectOnNotFound | Prisma.RejectPerOperation | false | undefined> {
     ...
     * })
    **/
    findUnique<T extends MuteFindUniqueArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args: SelectSubset<T, MuteFindUniqueArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findUnique', 'Mute'> extends True ? Prisma__MuteClient<MuteGetPayload<T>> : Prisma__MuteClient<MuteGetPayload<T> | null, null>
     ...
     * })
    **/
    findUniqueOrThrow<T extends MuteFindUniqueOrThrowArgs>(
      args?: SelectSubset<T, MuteFindUniqueOrThrowArgs>
    ): Prisma__MuteClient<MuteGetPayload<T>>
     ...
     * })
    **/
    findFirst<T extends MuteFindFirstArgs,  LocalRejectSettings = T["rejectOnNotFound"] extends RejectOnNotFound ? T['rejectOnNotFound'] : undefined>(
      args?: SelectSubset<T, MuteFindFirstArgs>
    ): HasReject<GlobalRejectSettings, LocalRejectSettings, 'findFirst', 'Mute'> extends True ? Prisma__MuteClient<MuteGetPayload<T>> : Prisma__MuteClient<MuteGetPayload<T> | null, null>
     ...
     * })
    **/
    findFirstOrThrow<T extends MuteFindFirstOrThrowArgs>(
      args?: SelectSubset<T, MuteFindFirstOrThrowArgs>
    ): Prisma__MuteClient<MuteGetPayload<T>>
     ...
     * 
    **/
    findMany<T extends MuteFindManyArgs>(
      args?: SelectSubset<T, MuteFindManyArgs>
    ): Prisma.PrismaPromise<Array<MuteGetPayload<T>>>
     ...
     * 
    **/
    create<T extends MuteCreateArgs>(
      args: SelectSubset<T, MuteCreateArgs>
    ): Prisma__MuteClient<MuteGetPayload<T>>
     ...
     *     
    **/
    createMany<T extends MuteCreateManyArgs>(
      args?: SelectSubset<T, MuteCreateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    delete<T extends MuteDeleteArgs>(
      args: SelectSubset<T, MuteDeleteArgs>
    ): Prisma__MuteClient<MuteGetPayload<T>>
     ...
     * 
    **/
    update<T extends MuteUpdateArgs>(
      args: SelectSubset<T, MuteUpdateArgs>
    ): Prisma__MuteClient<MuteGetPayload<T>>
     ...
     * 
    **/
    deleteMany<T extends MuteDeleteManyArgs>(
      args?: SelectSubset<T, MuteDeleteManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * 
    **/
    updateMany<T extends MuteUpdateManyArgs>(
      args: SelectSubset<T, MuteUpdateManyArgs>
    ): Prisma.PrismaPromise<BatchPayload>
     ...
     * })
    **/
    upsert<T extends MuteUpsertArgs>(
      args: SelectSubset<T, MuteUpsertArgs>
    ): Prisma__MuteClient<MuteGetPayload<T>>
   ...
   * https://github.com/prisma/prisma-client-js/issues/707
   */
  export class Prisma__MuteClient<T, Null = never> implements Prisma.PrismaPromise<T> {
    private readonly _dmmf;
    private readonly _queryType;
    private readonly _rootField;
    private readonly _clientMethod;
    ...
    channel<T extends ChannelsArgs= {}>(args?: Subset<T, ChannelsArgs>): Prisma__ChannelsClient<ChannelsGetPayload<T> | Null>;
  ...
  /**
   * Mute base type for findUnique actions
   */
  export type MuteFindUniqueArgsBase = {
    /**
     * Select specific fields to fetch from the Mute
     */
    select?: MuteSelect | null
   ...
   * Mute findUnique
   */
  export interface MuteFindUniqueArgs extends MuteFindUniqueArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findUniqueOrThrow` method instead
    */
   ...
   */
  export type MuteFindUniqueOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Mute
     */
    select?: MuteSelect | null
  ...
  /**
   * Mute base type for findFirst actions
   */
  export type MuteFindFirstArgsBase = {
    /**
     * Select specific fields to fetch from the Mute
     */
    select?: MuteSelect | null
   ...
   * Mute findFirst
   */
  export interface MuteFindFirstArgs extends MuteFindFirstArgsBase {
   /**
    * Throw an Error if query returns no results
    * @deprecated since 4.0.0: use `findFirstOrThrow` method instead
    */
   ...
   */
  export type MuteFindFirstOrThrowArgs = {
    /**
     * Select specific fields to fetch from the Mute
     */
    select?: MuteSelect | null
   ...
   * Mute createMany
   */
  export type MuteCreateManyArgs = {
    /**
     * The data used to create many Mutes.
     */
    data: Enumerable<MuteCreateManyInput>
    skipDuplicates?: boolean
  }
   ...
   * Mute updateMany
   */
  export type MuteUpdateManyArgs = {
    /**
   ...
   * Mute deleteMany
   */
  export type MuteDeleteManyArgs = {
    /**
  ...
  export type UsersWhereInput = {
    ...
    kicks?: ChannelsListRelationFilter
    bans?: ChannelsListRelationFilter
  ...
  export type UsersOrderByWithRelationInput = {
    ...
    kicks?: ChannelsOrderByRelationAggregateInput
    bans?: ChannelsOrderByRelationAggregateInput
  ...
  export type ChannelsWhereInput = {
    ...
    kicks?: UsersListRelationFilter
    bans?: UsersListRelationFilter
    mutedUsers?: MuteListRelationFilter
  }
  ...
  export type ChannelsOrderByWithRelationInput = {
    ...
    kicks?: UsersOrderByRelationAggregateInput
    bans?: UsersOrderByRelationAggregateInput
    mutedUsers?: MuteOrderByRelationAggregateInput
  }
  ...
  export type MuteWhereInput = {
    AND?: Enumerable<MuteWhereInput>
    OR?: Enumerable<MuteWhereInput>
    NOT?: Enumerable<MuteWhereInput>
    id?: IntFilter | number
    userId?: IntFilter | number
    channelId?: IntFilter | number
    muteEndTime?: DateTimeFilter | Date | string
    user?: XOR<UsersRelationFilter, UsersWhereInput>
    channel?: XOR<ChannelsRelationFilter, ChannelsWhereInput>
  }
  ...
  export type MuteWhereUniqueInput = {
    id?: number
  }
  ...
  export type MuteScalarWhereWithAggregatesInput = {
    AND?: Enumerable<MuteScalarWhereWithAggregatesInput>
    OR?: Enumerable<MuteScalarWhereWithAggregatesInput>
    NOT?: Enumerable<MuteScalarWhereWithAggregatesInput>
    id?: IntWithAggregatesFilter | number
    userId?: IntWithAggregatesFilter | number
    channelId?: IntWithAggregatesFilter | number
    muteEndTime?: DateTimeWithAggregatesFilter | Date | string
  }
  ...
  export type UsersCreateInput = {
    ...
    kicks?: ChannelsCreateNestedManyWithoutKicksInput
    bans?: ChannelsCreateNestedManyWithoutBansInput
    mutes?: MuteCreateNestedManyWithoutUserInput
  }
  ...
  export type UsersUncheckedCreateInput = {
    ...
    kicks?: ChannelsUncheckedCreateNestedManyWithoutKicksInput
    bans?: ChannelsUncheckedCreateNestedManyWithoutBansInput
    mutes?: MuteUncheckedCreateNestedManyWithoutUserInput
  }
  ...
  export type UsersUpdateInput = {
    ...
    kicks?: ChannelsUpdateManyWithoutKicksNestedInput
    bans?: ChannelsUpdateManyWithoutBansNestedInput
    mutes?: MuteUpdateManyWithoutUserNestedInput
  }
  ...
  export type UsersUncheckedUpdateInput = {
    ...
    kicks?: ChannelsUncheckedUpdateManyWithoutKicksNestedInput
    bans?: ChannelsUncheckedUpdateManyWithoutBansNestedInput
    mutes?: MuteUncheckedUpdateManyWithoutUserNestedInput
  }
  ...
  export type ChannelsCreateInput = {
    ...
    kicks?: UsersCreateNestedManyWithoutKicksInput
    bans?: UsersCreateNestedManyWithoutBansInput
    mutedUsers?: MuteCreateNestedManyWithoutChannelInput
  }
  ...
  export type ChannelsUncheckedCreateInput = {
    ...
    kicks?: UsersUncheckedCreateNestedManyWithoutKicksInput
    bans?: UsersUncheckedCreateNestedManyWithoutBansInput
    mutedUsers?: MuteUncheckedCreateNestedManyWithoutChannelInput
  }
  ...
  export type ChannelsUpdateInput = {
    ...
    kicks?: UsersUpdateManyWithoutKicksNestedInput
    bans?: UsersUpdateManyWithoutBansNestedInput
    mutedUsers?: MuteUpdateManyWithoutChannelNestedInput
  }
  ...
  export type ChannelsUncheckedUpdateInput = {
    ...
    kicks?: UsersUncheckedUpdateManyWithoutKicksNestedInput
    bans?: UsersUncheckedUpdateManyWithoutBansNestedInput
    mutedUsers?: MuteUncheckedUpdateManyWithoutChannelNestedInput
  }
  ...
  export type MuteCreateInput = {
    muteEndTime: Date | string
    user: UsersCreateNestedOneWithoutMutesInput
    channel: ChannelsCreateNestedOneWithoutMutedUsersInput
  }
  ...
  export type MuteUpdateInput = {
    muteEndTime?: DateTimeFieldUpdateOperationsInput | Date | string
    user?: UsersUpdateOneRequiredWithoutMutesNestedInput
    channel?: ChannelsUpdateOneRequiredWithoutMutedUsersNestedInput
  }
  ...
  export type ChannelsCreateNestedManyWithoutKicksInput = {
    create?: XOR<Enumerable<ChannelsCreateWithoutKicksInput>, Enumerable<ChannelsUncheckedCreateWithoutKicksInput>>
    connectOrCreate?: Enumerable<ChannelsCreateOrConnectWithoutKicksInput>
    connect?: Enumerable<ChannelsWhereUniqueInput>
  }

  export type ChannelsCreateNestedManyWithoutBansInput = {
    create?: XOR<Enumerable<ChannelsCreateWithoutBansInput>, Enumerable<ChannelsUncheckedCreateWithoutBansInput>>
    connectOrCreate?: Enumerable<ChannelsCreateOrConnectWithoutBansInput>
    connect?: Enumerable<ChannelsWhereUniqueInput>
  }

  export type MuteCreateNestedManyWithoutUserInput = {
    create?: XOR<Enumerable<MuteCreateWithoutUserInput>, Enumerable<MuteUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<MuteCreateOrConnectWithoutUserInput>
    createMany?: MuteCreateManyUserInputEnvelope
    connect?: Enumerable<MuteWhereUniqueInput>
  }
  ...
  export type ChannelsUncheckedCreateNestedManyWithoutKicksInput = {
    create?: XOR<Enumerable<ChannelsCreateWithoutKicksInput>, Enumerable<ChannelsUncheckedCreateWithoutKicksInput>>
    connectOrCreate?: Enumerable<ChannelsCreateOrConnectWithoutKicksInput>
    connect?: Enumerable<ChannelsWhereUniqueInput>
  }

  export type ChannelsUncheckedCreateNestedManyWithoutBansInput = {
    create?: XOR<Enumerable<ChannelsCreateWithoutBansInput>, Enumerable<ChannelsUncheckedCreateWithoutBansInput>>
    connectOrCreate?: Enumerable<ChannelsCreateOrConnectWithoutBansInput>
    connect?: Enumerable<ChannelsWhereUniqueInput>
  }
  ...
  export type ChannelsUpdateManyWithoutKicksNestedInput = {
    create?: XOR<Enumerable<ChannelsCreateWithoutKicksInput>, Enumerable<ChannelsUncheckedCreateWithoutKicksInput>>
    connectOrCreate?: Enumerable<ChannelsCreateOrConnectWithoutKicksInput>
    upsert?: Enumerable<ChannelsUpsertWithWhereUniqueWithoutKicksInput>
    set?: Enumerable<ChannelsWhereUniqueInput>
    disconnect?: Enumerable<ChannelsWhereUniqueInput>
    delete?: Enumerable<ChannelsWhereUniqueInput>
    connect?: Enumerable<ChannelsWhereUniqueInput>
    update?: Enumerable<ChannelsUpdateWithWhereUniqueWithoutKicksInput>
    updateMany?: Enumerable<ChannelsUpdateManyWithWhereWithoutKicksInput>
    deleteMany?: Enumerable<ChannelsScalarWhereInput>
  }

  export type ChannelsUpdateManyWithoutBansNestedInput = {
    create?: XOR<Enumerable<ChannelsCreateWithoutBansInput>, Enumerable<ChannelsUncheckedCreateWithoutBansInput>>
    connectOrCreate?: Enumerable<ChannelsCreateOrConnectWithoutBansInput>
    upsert?: Enumerable<ChannelsUpsertWithWhereUniqueWithoutBansInput>
    set?: Enumerable<ChannelsWhereUniqueInput>
    disconnect?: Enumerable<ChannelsWhereUniqueInput>
    delete?: Enumerable<ChannelsWhereUniqueInput>
    connect?: Enumerable<ChannelsWhereUniqueInput>
    update?: Enumerable<ChannelsUpdateWithWhereUniqueWithoutBansInput>
    updateMany?: Enumerable<ChannelsUpdateManyWithWhereWithoutBansInput>
    deleteMany?: Enumerable<ChannelsScalarWhereInput>
  }
  ...
  export type MuteUpdateManyWithoutUserNestedInput = {
    create?: XOR<Enumerable<MuteCreateWithoutUserInput>, Enumerable<MuteUncheckedCreateWithoutUserInput>>
    connectOrCreate?: Enumerable<MuteCreateOrConnectWithoutUserInput>
    upsert?: Enumerable<MuteUpsertWithWhereUniqueWithoutUserInput>
    createMany?: MuteCreateManyUserInputEnvelope
    set?: Enumerable<MuteWhereUniqueInput>
    disconnect?: Enumerable<MuteWhereUniqueInput>
    delete?: Enumerable<MuteWhereUniqueInput>
    connect?: Enumerable<MuteWhereUniqueInput>
    update?: Enumerable<MuteUpdateWithWhereUniqueWithoutUserInput>
    updateMany?: Enumerable<MuteUpdateManyWithWhereWithoutUserInput>
    deleteMany?: Enumerable<MuteScalarWhereInput>
  }
  ...
  export type ChannelsUncheckedUpdateManyWithoutKicksNestedInput = {
    create?: XOR<Enumerable<ChannelsCreateWithoutKicksInput>, Enumerable<ChannelsUncheckedCreateWithoutKicksInput>>
    connectOrCreate?: Enumerable<ChannelsCreateOrConnectWithoutKicksInput>
    upsert?: Enumerable<ChannelsUpsertWithWhereUniqueWithoutKicksInput>
    set?: Enumerable<ChannelsWhereUniqueInput>
  ...
  export type ChannelsUncheckedUpdateManyWithoutBansNestedInput = {
    create?: XOR<Enumerable<ChannelsCreateWithoutBansInput>, Enumerable<ChannelsUncheckedCreateWithoutBansInput>>
    connectOrCreate?: Enumerable<ChannelsCreateOrConnectWithoutBansInput>
    upsert?: Enumerable<ChannelsUpsertWithWhereUniqueWithoutBansInput>
    set?: Enumerable<ChannelsWhereUniqueInput>
  ...
  export type UsersCreateNestedManyWithoutKicksInput = {
    create?: XOR<Enumerable<UsersCreateWithoutKicksInput>, Enumerable<UsersUncheckedCreateWithoutKicksInput>>
    connectOrCreate?: Enumerable<UsersCreateOrConnectWithoutKicksInput>
    connect?: Enumerable<UsersWhereUniqueInput>
  }

  export type UsersCreateNestedManyWithoutBansInput = {
    create?: XOR<Enumerable<UsersCreateWithoutBansInput>, Enumerable<UsersUncheckedCreateWithoutBansInput>>
    connectOrCreate?: Enumerable<UsersCreateOrConnectWithoutBansInput>
    connect?: Enumerable<UsersWhereUniqueInput>
  }

  export type MuteCreateNestedManyWithoutChannelInput = {
    create?: XOR<Enumerable<MuteCreateWithoutChannelInput>, Enumerable<MuteUncheckedCreateWithoutChannelInput>>
    connectOrCreate?: Enumerable<MuteCreateOrConnectWithoutChannelInput>
    createMany?: MuteCreateManyChannelInputEnvelope
    connect?: Enumerable<MuteWhereUniqueInput>
  }
  ...
  export type UsersUncheckedCreateNestedManyWithoutKicksInput = {
    create?: XOR<Enumerable<UsersCreateWithoutKicksInput>, Enumerable<UsersUncheckedCreateWithoutKicksInput>>
    connectOrCreate?: Enumerable<UsersCreateOrConnectWithoutKicksInput>
    connect?: Enumerable<UsersWhereUniqueInput>
  }

  export type UsersUncheckedCreateNestedManyWithoutBansInput = {
    create?: XOR<Enumerable<UsersCreateWithoutBansInput>, Enumerable<UsersUncheckedCreateWithoutBansInput>>
    connectOrCreate?: Enumerable<UsersCreateOrConnectWithoutBansInput>
    connect?: Enumerable<UsersWhereUniqueInput>
  }

  export type MuteUncheckedCreateNestedManyWithoutChannelInput = {
    create?: XOR<Enumerable<MuteCreateWithoutChannelInput>, Enumerable<MuteUncheckedCreateWithoutChannelInput>>
    connectOrCreate?: Enumerable<MuteCreateOrConnectWithoutChannelInput>
    createMany?: MuteCreateManyChannelInputEnvelope
    connect?: Enumerable<MuteWhereUniqueInput>
  ...
  export type UsersUpdateManyWithoutKicksNestedInput = {
    create?: XOR<Enumerable<UsersCreateWithoutKicksInput>, Enumerable<UsersUncheckedCreateWithoutKicksInput>>
    connectOrCreate?: Enumerable<UsersCreateOrConnectWithoutKicksInput>
    upsert?: Enumerable<UsersUpsertWithWhereUniqueWithoutKicksInput>
    set?: Enumerable<UsersWhereUniqueInput>
    disconnect?: Enumerable<UsersWhereUniqueInput>
    delete?: Enumerable<UsersWhereUniqueInput>
    connect?: Enumerable<UsersWhereUniqueInput>
    update?: Enumerable<UsersUpdateWithWhereUniqueWithoutKicksInput>
    updateMany?: Enumerable<UsersUpdateManyWithWhereWithoutKicksInput>
    deleteMany?: Enumerable<UsersScalarWhereInput>
  }

  export type UsersUpdateManyWithoutBansNestedInput = {
    create?: XOR<Enumerable<UsersCreateWithoutBansInput>, Enumerable<UsersUncheckedCreateWithoutBansInput>>
    connectOrCreate?: Enumerable<UsersCreateOrConnectWithoutBansInput>
    upsert?: Enumerable<UsersUpsertWithWhereUniqueWithoutBansInput>
    set?: Enumerable<UsersWhereUniqueInput>
    disconnect?: Enumerable<UsersWhereUniqueInput>
    delete?: Enumerable<UsersWhereUniqueInput>
    connect?: Enumerable<UsersWhereUniqueInput>
    update?: Enumerable<UsersUpdateWithWhereUniqueWithoutBansInput>
    updateMany?: Enumerable<UsersUpdateManyWithWhereWithoutBansInput>
    deleteMany?: Enumerable<UsersScalarWhereInput>
  }

  export type MuteUpdateManyWithoutChannelNestedInput = {
    create?: XOR<Enumerable<MuteCreateWithoutChannelInput>, Enumerable<MuteUncheckedCreateWithoutChannelInput>>
    connectOrCreate?: Enumerable<MuteCreateOrConnectWithoutChannelInput>
    upsert?: Enumerable<MuteUpsertWithWhereUniqueWithoutChannelInput>
    createMany?: MuteCreateManyChannelInputEnvelope
    set?: Enumerable<MuteWhereUniqueInput>
    disconnect?: Enumerable<MuteWhereUniqueInput>
    delete?: Enumerable<MuteWhereUniqueInput>
    connect?: Enumerable<MuteWhereUniqueInput>
    update?: Enumerable<MuteUpdateWithWhereUniqueWithoutChannelInput>
    updateMany?: Enumerable<MuteUpdateManyWithWhereWithoutChannelInput>
    deleteMany?: Enumerable<MuteScalarWhereInput>
  }
  ...
  export type UsersUncheckedUpdateManyWithoutKicksNestedInput = {
    create?: XOR<Enumerable<UsersCreateWithoutKicksInput>, Enumerable<UsersUncheckedCreateWithoutKicksInput>>
    connectOrCreate?: Enumerable<UsersCreateOrConnectWithoutKicksInput>
    upsert?: Enumerable<UsersUpsertWithWhereUniqueWithoutKicksInput>
    set?: Enumerable<UsersWhereUniqueInput>
  ...
  export type UsersUncheckedUpdateManyWithoutBansNestedInput = {
    create?: XOR<Enumerable<UsersCreateWithoutBansInput>, Enumerable<UsersUncheckedCreateWithoutBansInput>>
    connectOrCreate?: Enumerable<UsersCreateOrConnectWithoutBansInput>
    upsert?: Enumerable<UsersUpsertWithWhereUniqueWithoutBansInput>
    set?: Enumerable<UsersWhereUniqueInput>
  ...
  export type MuteUncheckedUpdateManyWithoutChannelNestedInput = {
    create?: XOR<Enumerable<MuteCreateWithoutChannelInput>, Enumerable<MuteUncheckedCreateWithoutChannelInput>>
    connectOrCreate?: Enumerable<MuteCreateOrConnectWithoutChannelInput>
    upsert?: Enumerable<MuteUpsertWithWhereUniqueWithoutChannelInput>
    createMany?: MuteCreateManyChannelInputEnvelope
  ...
  export type UsersCreateNestedOneWithoutMutesInput = {
    create?: XOR<UsersCreateWithoutMutesInput, UsersUncheckedCreateWithoutMutesInput>
    connectOrCreate?: UsersCreateOrConnectWithoutMutesInput
    connect?: UsersWhereUniqueInput
  }

  export type ChannelsCreateNestedOneWithoutMutedUsersInput = {
    create?: XOR<ChannelsCreateWithoutMutedUsersInput, ChannelsUncheckedCreateWithoutMutedUsersInput>
    connectOrCreate?: ChannelsCreateOrConnectWithoutMutedUsersInput
    connect?: ChannelsWhereUniqueInput
  }

  export type UsersUpdateOneRequiredWithoutMutesNestedInput = {
    create?: XOR<UsersCreateWithoutMutesInput, UsersUncheckedCreateWithoutMutesInput>
    connectOrCreate?: UsersCreateOrConnectWithoutMutesInput
    upsert?: UsersUpsertWithoutMutesInput
    connect?: UsersWhereUniqueInput
    update?: XOR<UsersUpdateWithoutMutesInput, UsersUncheckedUpdateWithoutMutesInput>
  }

  export type ChannelsUpdateOneRequiredWithoutMutedUsersNestedInput = {
    create?: XOR<ChannelsCreateWithoutMutedUsersInput, ChannelsUncheckedCreateWithoutMutedUsersInput>
    connectOrCreate?: ChannelsCreateOrConnectWithoutMutedUsersInput
    upsert?: ChannelsUpsertWithoutMutedUsersInput
    connect?: ChannelsWhereUniqueInput
    update?: XOR<ChannelsUpdateWithoutMutedUsersInput, ChannelsUncheckedUpdateWithoutMutedUsersInput>
  }
  ...
  export type ChannelsCreateWithoutKicksInput = {
    name: string
    isPublic?: boolean
    password?: string | null
    owner: UsersCreateNestedOneWithoutChannelsOwnedInput
  ...
  export type ChannelsUncheckedCreateWithoutKicksInput = {
    id?: number
    name: string
    isPublic?: boolean
    password?: string | null
  ...
  export type ChannelsCreateOrConnectWithoutKicksInput = {
    where: ChannelsWhereUniqueInput
    create: XOR<ChannelsCreateWithoutKicksInput, ChannelsUncheckedCreateWithoutKicksInput>
  }

  export type ChannelsCreateWithoutBansInput = {
    name: string
    isPublic?: boolean
    password?: string | null
    owner: UsersCreateNestedOneWithoutChannelsOwnedInput
  ...
  export type ChannelsUncheckedCreateWithoutBansInput = {
    id?: number
    name: string
    isPublic?: boolean
    password?: string | null
  ...
  export type ChannelsCreateOrConnectWithoutBansInput = {
    where: ChannelsWhereUniqueInput
    create: XOR<ChannelsCreateWithoutBansInput, ChannelsUncheckedCreateWithoutBansInput>
  }
  ...
  export type MuteCreateOrConnectWithoutUserInput = {
    where: MuteWhereUniqueInput
    create: XOR<MuteCreateWithoutUserInput, MuteUncheckedCreateWithoutUserInput>
  }

  export type MuteCreateManyUserInputEnvelope = {
    data: Enumerable<MuteCreateManyUserInput>
    skipDuplicates?: boolean
  }
  ...
  export type ChannelsUpsertWithWhereUniqueWithoutKicksInput = {
    where: ChannelsWhereUniqueInput
    update: XOR<ChannelsUpdateWithoutKicksInput, ChannelsUncheckedUpdateWithoutKicksInput>
    create: XOR<ChannelsCreateWithoutKicksInput, ChannelsUncheckedCreateWithoutKicksInput>
  }

  export type ChannelsUpdateWithWhereUniqueWithoutKicksInput = {
    where: ChannelsWhereUniqueInput
    data: XOR<ChannelsUpdateWithoutKicksInput, ChannelsUncheckedUpdateWithoutKicksInput>
  }

  export type ChannelsUpdateManyWithWhereWithoutKicksInput = {
    where: ChannelsScalarWhereInput
    data: XOR<ChannelsUpdateManyMutationInput, ChannelsUncheckedUpdateManyWithoutKicksInput>
  }

  export type ChannelsUpsertWithWhereUniqueWithoutBansInput = {
    where: ChannelsWhereUniqueInput
    update: XOR<ChannelsUpdateWithoutBansInput, ChannelsUncheckedUpdateWithoutBansInput>
    create: XOR<ChannelsCreateWithoutBansInput, ChannelsUncheckedCreateWithoutBansInput>
  }

  export type ChannelsUpdateWithWhereUniqueWithoutBansInput = {
    where: ChannelsWhereUniqueInput
    data: XOR<ChannelsUpdateWithoutBansInput, ChannelsUncheckedUpdateWithoutBansInput>
  }

  export type ChannelsUpdateManyWithWhereWithoutBansInput = {
    where: ChannelsScalarWhereInput
    data: XOR<ChannelsUpdateManyMutationInput, ChannelsUncheckedUpdateManyWithoutBansInput>
  }

  export type MuteUpsertWithWhereUniqueWithoutUserInput = {
    where: MuteWhereUniqueInput
    update: XOR<MuteUpdateWithoutUserInput, MuteUncheckedUpdateWithoutUserInput>
    create: XOR<MuteCreateWithoutUserInput, MuteUncheckedCreateWithoutUserInput>
  }

  export type MuteUpdateWithWhereUniqueWithoutUserInput = {
    where: MuteWhereUniqueInput
    data: XOR<MuteUpdateWithoutUserInput, MuteUncheckedUpdateWithoutUserInput>
  }

  export type MuteUpdateManyWithWhereWithoutUserInput = {
    where: MuteScalarWhereInput
    data: XOR<MuteUpdateManyMutationInput, MuteUncheckedUpdateManyWithoutMutesInput>
  }

  export type MuteScalarWhereInput = {
    AND?: Enumerable<MuteScalarWhereInput>
    OR?: Enumerable<MuteScalarWhereInput>
    NOT?: Enumerable<MuteScalarWhereInput>
    id?: IntFilter | number
    userId?: IntFilter | number
    channelId?: IntFilter | number
    muteEndTime?: DateTimeFilter | Date | string
  ...
  export type UsersCreateWithoutKicksInput = {
    email: string
    hash: string
    username: string
    access_token: string
  ...
  export type UsersUncheckedCreateWithoutKicksInput = {
    id?: number
    email: string
    hash: string
    username: string
  ...
  export type UsersCreateOrConnectWithoutKicksInput = {
    where: UsersWhereUniqueInput
    create: XOR<UsersCreateWithoutKicksInput, UsersUncheckedCreateWithoutKicksInput>
  }
  ...
  export type UsersCreateOrConnectWithoutBansInput = {
    where: UsersWhereUniqueInput
    create: XOR<UsersCreateWithoutBansInput, UsersUncheckedCreateWithoutBansInput>
  }

  export type MuteCreateWithoutChannelInput = {
    muteEndTime: Date | string
    user: UsersCreateNestedOneWithoutMutesInput
  }

  export type MuteUncheckedCreateWithoutChannelInput = {
    id?: number
    userId: number
    muteEndTime: Date | string
  }

  export type MuteCreateOrConnectWithoutChannelInput = {
    where: MuteWhereUniqueInput
    create: XOR<MuteCreateWithoutChannelInput, MuteUncheckedCreateWithoutChannelInput>
  }

  export type MuteCreateManyChannelInputEnvelope = {
    data: Enumerable<MuteCreateManyChannelInput>
    skipDuplicates?: boolean
  }
  ...
  export type UsersUpsertWithWhereUniqueWithoutKicksInput = {
    where: UsersWhereUniqueInput
    update: XOR<UsersUpdateWithoutKicksInput, UsersUncheckedUpdateWithoutKicksInput>
    create: XOR<UsersCreateWithoutKicksInput, UsersUncheckedCreateWithoutKicksInput>
  }

  export type UsersUpdateWithWhereUniqueWithoutKicksInput = {
    where: UsersWhereUniqueInput
    data: XOR<UsersUpdateWithoutKicksInput, UsersUncheckedUpdateWithoutKicksInput>
  }

  export type UsersUpdateManyWithWhereWithoutKicksInput = {
    where: UsersScalarWhereInput
    data: XOR<UsersUpdateManyMutationInput, UsersUncheckedUpdateManyWithoutKicksInput>
  }

  export type UsersUpsertWithWhereUniqueWithoutBansInput = {
    where: UsersWhereUniqueInput
    update: XOR<UsersUpdateWithoutBansInput, UsersUncheckedUpdateWithoutBansInput>
    create: XOR<UsersCreateWithoutBansInput, UsersUncheckedCreateWithoutBansInput>
  }

  export type UsersUpdateWithWhereUniqueWithoutBansInput = {
    where: UsersWhereUniqueInput
    data: XOR<UsersUpdateWithoutBansInput, UsersUncheckedUpdateWithoutBansInput>
  }

  export type UsersUpdateManyWithWhereWithoutBansInput = {
    where: UsersScalarWhereInput
    data: XOR<UsersUpdateManyMutationInput, UsersUncheckedUpdateManyWithoutBansInput>
  }

  export type MuteUpsertWithWhereUniqueWithoutChannelInput = {
    where: MuteWhereUniqueInput
    update: XOR<MuteUpdateWithoutChannelInput, MuteUncheckedUpdateWithoutChannelInput>
    create: XOR<MuteCreateWithoutChannelInput, MuteUncheckedCreateWithoutChannelInput>
  }

  export type MuteUpdateWithWhereUniqueWithoutChannelInput = {
    where: MuteWhereUniqueInput
    data: XOR<MuteUpdateWithoutChannelInput, MuteUncheckedUpdateWithoutChannelInput>
  }

  export type MuteUpdateManyWithWhereWithoutChannelInput = {
    where: MuteScalarWhereInput
    data: XOR<MuteUpdateManyMutationInput, MuteUncheckedUpdateManyWithoutMutedUsersInput>
  }

  export type UsersCreateWithoutMutesInput = {
    email: string
    hash: string
    username: string
    access_token: string
  ...
  export type UsersUncheckedCreateWithoutMutesInput = {
    id?: number
    email: string
    hash: string
    username: string
  ...
  export type UsersCreateOrConnectWithoutMutesInput = {
    where: UsersWhereUniqueInput
    create: XOR<UsersCreateWithoutMutesInput, UsersUncheckedCreateWithoutMutesInput>
  }

  export type ChannelsCreateWithoutMutedUsersInput = {
    name: string
    isPublic?: boolean
    password?: string | null
    owner: UsersCreateNestedOneWithoutChannelsOwnedInput
  ...
  export type ChannelsUncheckedCreateWithoutMutedUsersInput = {
    id?: number
    name: string
    isPublic?: boolean
    password?: string | null
  ...
  export type ChannelsCreateOrConnectWithoutMutedUsersInput = {
    where: ChannelsWhereUniqueInput
    create: XOR<ChannelsCreateWithoutMutedUsersInput, ChannelsUncheckedCreateWithoutMutedUsersInput>
  }

  export type UsersUpsertWithoutMutesInput = {
    update: XOR<UsersUpdateWithoutMutesInput, UsersUncheckedUpdateWithoutMutesInput>
    create: XOR<UsersCreateWithoutMutesInput, UsersUncheckedCreateWithoutMutesInput>
  }

  export type UsersUpdateWithoutMutesInput = {
    email?: StringFieldUpdateOperationsInput | string
    hash?: StringFieldUpdateOperationsInput | string
    username?: StringFieldUpdateOperationsInput | string
    access_token?: StringFieldUpdateOperationsInput | string
  ...
  export type UsersUncheckedUpdateWithoutMutesInput = {
    id?: IntFieldUpdateOperationsInput | number
    email?: StringFieldUpdateOperationsInput | string
    hash?: StringFieldUpdateOperationsInput | string
    username?: StringFieldUpdateOperationsInput | string
  ...
  export type ChannelsUpsertWithoutMutedUsersInput = {
    update: XOR<ChannelsUpdateWithoutMutedUsersInput, ChannelsUncheckedUpdateWithoutMutedUsersInput>
    create: XOR<ChannelsCreateWithoutMutedUsersInput, ChannelsUncheckedCreateWithoutMutedUsersInput>
  }

  export type ChannelsUpdateWithoutMutedUsersInput = {
    name?: StringFieldUpdateOperationsInput | string
    isPublic?: BoolFieldUpdateOperationsInput | boolean
    password?: NullableStringFieldUpdateOperationsInput | string | null
    owner?: UsersUpdateOneRequiredWithoutChannelsOwnedNestedInput
  ...
  export type ChannelsUncheckedUpdateWithoutMutedUsersInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    isPublic?: BoolFieldUpdateOperationsInput | boolean
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ChannelsUpdateWithoutKicksInput = {
    name?: StringFieldUpdateOperationsInput | string
    isPublic?: BoolFieldUpdateOperationsInput | boolean
    password?: NullableStringFieldUpdateOperationsInput | string | null
    owner?: UsersUpdateOneRequiredWithoutChannelsOwnedNestedInput
  ...
  export type ChannelsUncheckedUpdateWithoutKicksInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    isPublic?: BoolFieldUpdateOperationsInput | boolean
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ChannelsUncheckedUpdateManyWithoutKicksInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    isPublic?: BoolFieldUpdateOperationsInput | boolean
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ChannelsUpdateWithoutBansInput = {
    name?: StringFieldUpdateOperationsInput | string
    isPublic?: BoolFieldUpdateOperationsInput | boolean
    password?: NullableStringFieldUpdateOperationsInput | string | null
    owner?: UsersUpdateOneRequiredWithoutChannelsOwnedNestedInput
  ...
  export type ChannelsUncheckedUpdateWithoutBansInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    isPublic?: BoolFieldUpdateOperationsInput | boolean
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type ChannelsUncheckedUpdateManyWithoutBansInput = {
    id?: IntFieldUpdateOperationsInput | number
    name?: StringFieldUpdateOperationsInput | string
    isPublic?: BoolFieldUpdateOperationsInput | boolean
    password?: NullableStringFieldUpdateOperationsInput | string | null
  ...
  export type MuteUncheckedUpdateManyWithoutMutesInput = {
    id?: IntFieldUpdateOperationsInput | number
    channelId?: IntFieldUpdateOperationsInput | number
    muteEndTime?: DateTimeFieldUpdateOperationsInput | Date | string
  }

  export type MuteCreateManyChannelInput = {
    id?: number
    userId: number
    muteEndTime: Date | string
  }
  ...
  export type UsersUpdateWithoutKicksInput = {
    email?: StringFieldUpdateOperationsInput | string
    hash?: StringFieldUpdateOperationsInput | string
    username?: StringFieldUpdateOperationsInput | string
    access_token?: StringFieldUpdateOperationsInput | string
  ...
  export type UsersUncheckedUpdateWithoutKicksInput = {
    id?: IntFieldUpdateOperationsInput | number
    email?: StringFieldUpdateOperationsInput | string
    hash?: StringFieldUpdateOperationsInput | string
    username?: StringFieldUpdateOperationsInput | string
  ...
  export type UsersUncheckedUpdateManyWithoutKicksInput = {
    id?: IntFieldUpdateOperationsInput | number
    email?: StringFieldUpdateOperationsInput | string
    hash?: StringFieldUpdateOperationsInput | string
    username?: StringFieldUpdateOperationsInput | string
  ...
  export type UsersUncheckedUpdateManyWithoutBansInput = {
    id?: IntFieldUpdateOperationsInput | number
    email?: StringFieldUpdateOperationsInput | string
    hash?: StringFieldUpdateOperationsInput | string
    username?: StringFieldUpdateOperationsInput | string
  ...
  export type MuteUpdateWithoutChannelInput = {
    muteEndTime?: DateTimeFieldUpdateOperationsInput | Date | string
    user?: UsersUpdateOneRequiredWithoutMutesNestedInput
  }

  export type MuteUncheckedUpdateWithoutChannelInput = {
    id?: IntFieldUpdateOperationsInput | number
    userId?: IntFieldUpdateOperationsInput | number
    muteEndTime?: DateTimeFieldUpdateOperationsInput | Date | string
  }

  export type MuteUncheckedUpdateManyWithoutMutedUsersInput = {
    id?: IntFieldUpdateOperationsInput | number
    userId?: IntFieldUpdateOperationsInput | number
    muteEndTime?: DateTimeFieldUpdateOperationsInput | Date | string
  }
